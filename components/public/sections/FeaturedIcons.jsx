...
import LandmarkCard3D from '@/components/shared/LandmarkCard3D'
import { FEATURED_ICONS } from '@/lib/content/homepage'

export default function FeaturedIcons({ data }) {
  const content = data || FEATURED_ICONS;
    ...
    >
      ...
      <div className="mt-8 flex items-center justify-between gap-6">
        ...
        <div className="flex-1 max-w-md flex items-center gap-3">
          ...
          <span className="font-mono text-xs text-bekasi-ink/50">
            {String(snaps.length || content.items.length).padStart(2, '0')}
          </span>
        </div>
