 ...
 */
export default function FloatingCityShowcase({ data }) {
  const content = data || FLOATING_CITY;
        ...
        <div className="grid lg:grid-cols-12 gap-14 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-square max-w-[640px] mx-auto">
              ...
              <div
                className="absolute z-20 w-[38%] h-[38%] pointer-events-none transition-transform duration-500 ease-out"
                style={{
                  bottom: '6%',
                  right: '-10%',
