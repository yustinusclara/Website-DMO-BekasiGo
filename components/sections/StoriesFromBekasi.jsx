      ...
      <div className="container py-24 md:py-32 lg:py-36">
        ...
        <div className="mt-14 md:mt-20 grid lg:grid-cols-12 gap-8 lg:gap-16 items-end">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <span className="eyebrow eyebrow-dot text-bekasi-emerald-700">{STORIES.eyebrow}</span>
              <span aria-hidden className="h-px w-8 bg-bekasi-emerald-900/20" />
              <span className="mono text-bekasi-ink/50">{STORIES.issue}</span>
            </div>
          ...
          >
            <p className="body-lg text-bekasi-ink/70 max-w-lg">{STORIES.kicker}</p>
            <div className="mt-5 flex items-center gap-2 text-xs text-bekasi-ink/50">
              <FileText className="h-3.5 w-3.5" />
              <span className="font-mono">{STORIES.totalStories}</span> stories in the archive
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <Link href={STORIES.action.href} className="link-underline text-sm text-bekasi-emerald-900">
        ...
        <div className="mt-20 md:mt-28">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href={STORIES.action.href} className="hidden md:inline-flex items-center gap-1.5 text-sm font-medium text-bekasi-emerald-900 hover:text-bekasi-emerald-700">
              {STORIES.action.label} <ArrowUpRight className="h-4 w-4" />
            </Link>
          </div>
        ...
        <div className="mt-16 md:mt-20 pt-8 border-t border-black/[0.06] flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link href={STORIES.secondaryAction.href} className="btn-ghost btn-md text-bekasi-emerald-900">
              {STORIES.secondaryAction.label}
            </Link>
            <Link href={STORIES.action.href}>
              <button className="btn-primary btn-md">
                <FileText className="h-4 w-4" /> {STORIES.action.label}
