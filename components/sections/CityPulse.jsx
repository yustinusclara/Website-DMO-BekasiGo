    ...
    <section id="events" className="relative overflow-hidden bg-bekasi-cream">
      <div className="container py-24 md:py-32 lg:py-36">
        ...
        <div className="mt-14 md:mt-20 grid lg:grid-cols-12 gap-8 lg:gap-16 items-end">
          ...
          >
            <span className="eyebrow eyebrow-dot text-bekasi-emerald-700">{CITY_PULSE.eyebrow}</span>
          ...
          >
            <p className="body-lg text-bekasi-ink/70 max-w-lg">{CITY_PULSE.kicker}</p>
            <Link
              href={CITY_PULSE.action.href}
            ...
            >
              {CITY_PULSE.action.label} <ArrowUpRight className="h-4 w-4" />
            </Link>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="flex-1 overflow-hidden relative mask-fade-r">
            <div className="flex whitespace-nowrap animate-marquee gap-10 py-3">
              {[...CITY_PULSE.liveNow, ...CITY_PULSE.liveNow].map((e, i) => {
        ...
        <div className="mt-8 md:mt-10 grid lg:grid-cols-12 gap-6 md:gap-8">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="chip-light font-mono">{CITY_PULSE.upcoming.length} events</span>
            </div>

            <ul className="flex-1 flex flex-col divide-y divide-black/[0.06]">
              {CITY_PULSE.upcoming.map((e) => {
                const Icon = TAG_ICON[e.tag] ?? Landmark
                return (
                  <li key={e.href}>
                    <Link
            ...
            >
              See all events · <span className="text-bekasi-ink/50">{CITY_PULSE.totalEvents} on the calendar</span>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-bekasi-ink/60">Filter by month, category, and neighborhood — {CITY_PULSE.totalEvents} events on the live calendar.</p>
            </div>
          </div>
          <Link href="/events">
