...
export default function PlannerCTAStrip({ dest }) {
  return (
        ...
        >
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl md:text-4xl lg:text-5xl leading-[1.05] tracking-tight text-balance max-w-3xl">
              Build a full-day around {dest.title}.
            </h2>
            <p className="mt-4 text-white/70 max-w-2xl leading-relaxed">
              Our AI planner takes your interests, timing, and pace—and threads them through {dest.title} plus nearby stops for a complete Bekasi day.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-3">
            <Link href={`/planner?seed=${dest.slug}`}>
