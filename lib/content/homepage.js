...
export const IMG = {
  // Landmarks (numbered per official asset library — v1783096xxx set, June 2026 refresh)
  stadionPatriot:        `${CLOUDINARY}/image/upload/v1783096743/1._Stadion_Patriot_Candrabhaga_udgobf.png`,
  piramidaSummarecon:    `${CLOUDINARY}/image/upload/v1783096743/2._Piramida_Terbalik_Summarecon_Bekasi_tjj38r.png`,
  summareconMall:        `${CLOUDINARY}/image/upload/v1783096744/3._Summarecon_Mall_Bekasi_avsah4.png`,
  monumenKaliBekasi:     `${CLOUDINARY}/image/upload/v1783096744/4._Monumen_Kali_Bekasi_eurdsg.png`,
  stasiunBekasi:         `${CLOUDINARY}/image/upload/v1783096745/5._Stasiun_Bekasi_innxew.png`,
  hokLayKiong:           `${CLOUDINARY}/image/upload/v1783096747/6._Klenteng_Hok_Lay_Kiong_Margahayu_znfukk.png`,
  kampungBali:           `${CLOUDINARY}/image/upload/v1783108680/7._Kampung_Bali_Harapan_Jaya_alcqcl.png`,
  transParkMall:         `${CLOUDINARY}/image/upload/v1783096743/8._Trans_Park_Mall_Juanda_Bekasi_yapzzj.png`,
  pakuwonMall:           `${CLOUDINARY}/image/upload/v1783096742/9._Pakuwon_Mall_Bekasi_piy2hp.png`,
  metropolitanMall:      `${CLOUDINARY}/image/upload/v1783096743/10._Metropolitan_Mall_Bekasi_pofuyg.png`,
  grandMetropolitanMall: `${CLOUDINARY}/image/upload/v1783096744/11._Grand_Metropolitan_Mall_Bekasi_k3xhh8.png`,
  monumenPerjuangan:     `${CLOUDINARY}/image/upload/v1783096743/12._Monumen_Perjuangan_Rakyat_Bekasi_h1i9d7.png`,
  gedungJuang45:         `${CLOUDINARY}/image/upload/v1783096744/13._Gedung_Juang_45_jl6i3p.png`,
  kampungAdatKranggan:   `${CLOUDINARY}/image/upload/v1783096744/14._Kampung_Adat_Kranggan_Bekasi_fjz6gg.png`,
  situRawaGede:          `${CLOUDINARY}/image/upload/v1783096744/15._Situ_Rawa_Gede_Bekasi_lp58ir.png`,

  // Signature Floating Smart City (refreshed)
  floatingCity:          `${CLOUDINARY}/image/upload/v1783097449/Kota_Bekasi_Floating_Smart_City_wh2jyu.png`,
  floatingCityBg:        `${CLOUDINARY}/image/upload/v1783064956/Kota_Bekasi_Floating_Smart_CIty_enlarge_bg_1_vk38en.png`,
  floatingCityCutout:    `${CLOUDINARY}/image/upload/v1783096743/Kota_Bekasi_Floating_Smart_CIty_without_background_fix_bglvxb.png`,
}

export const VIDEO = {
  // f_auto: serves the lightest supported format (webm/av1 → h264 fallback)
  // q_auto:eco: aggressive compression tuned for background video
  // w_1920,c_limit: cap resolution at 1920px width (no upscaling)
  hero: `${CLOUDINARY}/video/upload/f_auto,q_auto:eco,w_1920,c_limit/v1783064976/Video_Hero_Section_ntlr1b.mp4`,
}

export const NAV = {
  // Primary top-level items rendered in the header row.
  // Items with `mega` render a mega-menu dropdown on hover / tap.
  primary: [
    {
      ...
      mega: {
        featured: {
          ...
          kicker: 'A curated intro to the neighborhoods, culture, and rhythm of Kota Bekasi.',
          image: `${CLOUDINARY}/image/upload/v1783064956/Kota_Bekasi_Floating_Smart_City_bw0qge.jpg`,
          href: '/discover',
          cta: 'Open the guide',
        },
        groups: [
          {
            title: 'By theme',
            links: [
              { label: 'Heritage & Culture',   href: '/discover/heritage',  cat: 'heritage' },
              { label: 'Urban Lifestyle',      href: '/discover/urban',     cat: 'urban' },
              { label: 'Nature & Waterfront',  href: '/discover/nature',    cat: 'nature' },
              { label: 'Family Friendly',      href: '/discover/family',    cat: 'family' },
            ],
          },
          {
            title: 'Essentials',
            links: [
              { label: 'Food & Drink',   href: '/food',           cat: 'culinary' },
              { label: 'Stay',           href: '/stay',           cat: 'lifestyle' },
              { label: 'Getting Around', href: '/getting-around', cat: 'transit' },
              { label: 'Journal & News', href: '/blog',           cat: 'urban' },
            ],
          },
        ],
      },
  ...
  cta: { label: 'Smart Trip Planner', href: '/planner' },
  utility: [
    { label: 'Press',    href: '/press' },
    { label: 'Partners', href: '/partners' },
    { label: 'CMS',      href: '/admin' },
  ],
  // Mobile drawer grouping — visually reorganized for touch UX
  mobileGroups: [
    {
      title: 'Discover',
      links: [
  ...
  categories: [
    ...
    },
    {
      ...
      samples: [
        ...
        { name: 'Trans Park Culinary Row',    href: '/destinations/trans-park-mall-juanda' },
        { name: 'Bekasi Culinary Fest 2025',  href: '/events/bekasi-food-fair-vol-8' },
      ],
    },
    {
      id: 'events',
      ...
      samples: [
        { name: 'Betawi Heritage Parade',        href: '/events/bekasi-cultural-festival-2026' },
        { name: 'Smart City Innovation Expo',    href: '/events/skyline-sunset-rooftop-series' },
        { name: 'Situ Rawa Gede Trail Run',      href: '/events/bekasi-marathon-2026' },
      ],
    },
    {
      id: 'shopping',
      ...
      samples: [
        { name: 'Summarecon Mall Bekasi',        href: '/destinations/summarecon-mall-bekasi' },
        { name: 'Grand Metropolitan Mall',       href: '/destinations/grand-metropolitan-mall' },
        { name: 'Pakuwon Mall Bekasi',           href: '/destinations/pakuwon-mall-bekasi' },
      ],
    },
    {
      id: 'family',
      ...
      samples: [
        { name: 'Piramida Terbalik Summarecon',  href: '/destinations/piramida-terbalik-summarecon' },
        { name: 'Metropolitan Mall Bekasi',      href: '/destinations/metropolitan-mall-bekasi' },
    ...
    },
    {
      ...
      samples: [
        ...
        { name: 'Kali Malang Riverfront',        href: '/destinations/monumen-kali-bekasi' },
      ],
    },
    {
      id: 'transport',
...
export const FEATURED_ICONS = {
  ...
  items: [
    { title: 'Stadion Patriot Candrabhaga', category: 'Sport',    district: 'Bekasi Selatan', meta: 'Sport · Bekasi Selatan', image: IMG.stadionPatriot,     href: '/destinations/stadion-patriot-candrabhaga' },
    { title: 'Piramida Terbalik Summarecon',category: 'Urban',    district: 'Marga Mulya',    meta: 'Urban · Marga Mulya',    image: IMG.piramidaSummarecon, href: '/destinations/piramida-terbalik-summarecon' },
...
export const HERITAGE = {
  ...
  items: [
    ...
    },
    {
      ...
      href:  '/destinations/kampung-bali-harapan-jaya',
    },
    {
  ...
  items: [
    {
      ...
      image: IMG.summareconMall,
      href: '/destinations/summarecon-mall-bekasi',
    },
    {
    ...
    },
    {
      ...
      href: '/destinations/metropolitan-mall-bekasi',
    },
    {
      id: 'pakuwon',
      ...
      href: '/destinations/pakuwon-mall-bekasi',
    },
    {
      id: 'trans-park',
      ...
      image: IMG.transParkMall,
      href: '/destinations/trans-park-mall-juanda',
    },
  ],
}
...
export const CITY_PULSE = {
  ...
  featured: {
    ...
    image: IMG.summareconMall,
    href:  '/events/bekasi-food-fair-vol-8',
  },
  upcoming: [
    { date: { d: '28', m: 'JUN' }, day: 'SAT', title: 'Betawi Heritage Parade',           venue: 'Kampung Sawah',            tag: 'Culture', href: '/events/bekasi-cultural-festival-2026' },
    { date: { d: '05', m: 'JUL' }, day: 'SAT', title: 'Smart City Innovation Expo',       venue: 'Summarecon Convention',    tag: 'Tech',    href: '/events/skyline-sunset-rooftop-series' },
    { date: { d: '12', m: 'JUL' }, day: 'SAT', title: 'Situ Rawa Gede Nature Trail Run',  venue: 'Bantar Gebang',            tag: 'Sport',   href: '/events/bekasi-marathon-2026' },
    { date: { d: '19', m: 'JUL' }, day: 'SAT', title: 'Kampung Adat Kranggan Ritual',     venue: 'Jatirangga',               tag: 'Culture', href: '/events/kranggan-adat-ceremony' },
    { date: { d: '26', m: 'JUL' }, day: 'SAT', title: 'Bekasi Youth Music Festival',      venue: 'Grand Metropolitan',       tag: 'Music',   href: '/events/indie-music-night-july' },
  ],
  totalEvents: 48,
}
...
export const STORIES = {
  ...
  featured: {
    ...
    href:      '/stories/wayang-modern-night-behind-the-scenes',
  },
  items: [
    {
      ...
      tag: 'Culinary',
      image: IMG.transParkMall,
      href: '/stories/the-city-that-eats-standing-up',
    },
    {
      ...
      tag: 'Youth',
      image: IMG.piramidaSummarecon,
      href: '/stories/a-skyline-in-motion',
    },
    {
      ...
      tag: 'Lifestyle',
      image: IMG.situRawaGede,
      href: '/stories/return-of-kranggan-ritual',
    },
  ],
  totalStories: 42,
}
...
export const BLOG = {
  chapter: 'Chapter 09 · From the Blog',
  eyebrow: 'From the Blog',
  title: 'Practical guides & fresh reads.',
  kicker:
    'Travel tips, itinerary ideas, city updates, and hidden-gem guides \u2014 the practical side of Kota Bekasi.',
  action:         { label: 'Read all articles',   href: '/blog' },
  secondaryAction:{ label: 'Subscribe',           href: '/newsletter' },
  categories: [
    { id: 'all',       label: 'All' },
  ...
  featured: {
    title: '48 Hours in Bekasi: A First-Timer Itinerary',
    slug:  '48-hours-in-bekasi-first-timer',
    excerpt: 'Two days, four neighborhoods, and everything you need to feel Bekasi \u2014 from Klenteng dawns to rooftop nights. A step-by-step first-timer guide.',
    category: 'Guides',
    tags: ['Itinerary', 'Weekend', 'First-timer'],
    date: 'Jun 12, 2025',
    readTime: '9 min read',
    image: IMG.summareconMall,
    href: '/blog/the-perfect-weekend-in-bekasi-48-hour-guide',
  },
  compact: [
    { title: 'The Best Warung Sate in East Bekasi',        category: 'Food',      date: 'Jun 09, 2025', readTime: '5 min', image: IMG.transParkMall,    href: '/blog/new-cafe-openings-in-bekasi-june-2026' },
    { title: 'Ramadan Nights: A Cultural Calendar',        category: 'Culture',   date: 'Jun 04, 2025', readTime: '7 min', image: IMG.gedungJuang45,    href: '/blog/ramadan-in-bekasi-timings-and-events-2026' },
    { title: 'LRT Jabodebek: A Rider\u2019s Guide from Bekasi',category: 'Transport', date: 'May 30, 2025', readTime: '6 min', image: IMG.stasiunBekasi,    href: '/blog/lrt-jabodebek-latest-schedule-and-tips' },
  ],
  grid: [
    { title: 'Kid-Friendly Weekends at Situ Rawa Gede',  category: 'Family',  date: 'May 25, 2025', readTime: '4 min', image: IMG.situRawaGede,       href: '/blog/family-day-trip-guide-in-bekasi' },
    { title: 'A Sundanese Coffee Trail in Kranggan',      category: 'Food',    date: 'May 18, 2025', readTime: '5 min', image: IMG.kampungAdatKranggan,href: '/blog/first-time-visitor-tips-for-bekasi' },
    { title: 'Where to Watch the Skyline at Golden Hour', category: 'Guides',  date: 'May 11, 2025', readTime: '3 min', image: IMG.piramidaSummarecon, href: '/blog/best-time-to-visit-bekasi' },
  ],
  totalPosts: 128,
}
...
export const FOOTER = {
  ...
  // Tourism-trust: signals that this is the official DMO
  trust: {
    badge: 'Official Destination Management Organization',
    since: 'Est. 2025 · Kota Bekasi',
    partners: [
      { name: 'Pemerintah Kota Bekasi',       kicker: 'City Government' },
      { name: 'Dinas Pariwisata',              kicker: 'Tourism Board' },
      { name: 'Wonderful Indonesia',           kicker: 'National Tourism' },
      { name: 'Kadin Bekasi',                  kicker: 'Business Chamber' },
      { name: 'Bekasi Creative Hub',           kicker: 'Creative Economy' },
    ],
  },
}
