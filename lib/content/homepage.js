...
export const QUICK_EXPLORE = {
  ...
  items: [
    { label: 'Heritage',   icon: 'landmark',    href: '/discover/heritage' },
    { label: 'Culinary',   icon: 'utensils',    href: '/discover/culinary' },
    { label: 'Events',     icon: 'ticket',      href: '/events' },
    { label: 'Shopping',   icon: 'shopping-bag',href: '/discover/shopping' },
    { label: 'Family',     icon: 'baby',        href: '/discover/family' },
    { label: 'Waterfront', icon: 'trees',       href: '/discover/nature' },
    { label: 'Transport',  icon: 'train',       href: '/discover/access' },
    { label: 'Nightlife',  icon: 'moon',        href: '/discover/nightlife' },
  ],
}

export const FLOATING_CITY = {
  eyebrow: 'The Signature of Bekasi',
  title: 'A floating city where\nSmart meets Heritage.',
  kicker:
    'Bekasi is being reimagined — an urban vision that fuses centuries of Betawi, Sundanese and Peranakan roots with a future-facing smart-city skyline.',
  cta: { label: 'Discover Bekasi', href: '/discover' },
  image: IMG.floatingCityCutout,
  bg: IMG.floatingCityBg,
  pillars: [
    { k: 'Smart City',  v: 'Digital-first, connected, mobile-native' },
    { k: 'Heritage',    v: '300 years of living Betawi culture' },
    { k: 'Green Urban', v: 'Waterfront, parks, and open squares' },
    { k: 'Youthful',    v: 'A capital-adjacent creative rising city' },
  ],
}
...
export const FEATURED_ICONS = {
  ...
  items: [
    { title: 'Stadion Patriot Candrabhaga', category: 'Sport',    image: IMG.stadionPatriot,    href: '/destinations/stadion-patriot' },
    { title: 'Piramida Terbalik Summarecon',category: 'Urban',    image: IMG.piramidaSummarecon,href: '/destinations/piramida-summarecon' },
    { title: 'Stasiun Bekasi',              category: 'Transit',  image: IMG.stasiunBekasi,     href: '/destinations/stasiun-bekasi' },
    { title: 'Monumen Kali Bekasi',         category: 'Civic',    image: IMG.monumenKaliBekasi, href: '/destinations/monumen-kali-bekasi' },
    { title: 'Gedung Juang 45',             category: 'Heritage', image: IMG.gedungJuang45,     href: '/destinations/gedung-juang-45' },
    { title: 'Situ Rawa Gede',              category: 'Nature',   image: IMG.situRawaGede,      href: '/destinations/situ-rawa-gede' },
  ],
}

export const HERITAGE = {
  eyebrow: 'Heritage & Culture',
  title: 'A city with roots older than its skyline.',
  kicker:
  ...
  featureCaption: {
    tag: 'Featured Story',
    title: 'The 300-year-old temple that watches over the city.',
    meta: 'Klenteng Hok Lay Kiong · Cultural Heritage',
  },
  cards: [
    { title: 'Kampung Bali, Harapan Jaya',   meta: 'Balinese diaspora village',   image: IMG.kampungBali },
    { title: 'Kampung Adat Kranggan',         meta: 'Living Sundanese heritage',   image: IMG.kampungAdatKranggan },
    { title: 'Gedung Juang 45',               meta: 'Independence-era landmark',   image: IMG.gedungJuang45 },
  ],
}
